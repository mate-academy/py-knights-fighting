...
def test_base_knights(base_knights_config: dict) -> None:
...
def test_lancelot_overpowered(base_knights_config: dict) -> None:
...
def test_red_knight_overpowered(base_knights_config: dict) -> None:
...
def test_lancelot_has_armour(base_knights_config: dict) -> None:
...
def test_mordred_sword_is_not_poisoned(base_knights_config: dict) -> None:
...
def test_arthur_armour_weak(base_knights_config: dict) -> None:
...
def test_arthur_and_lancelot_have_potion(base_knights_config: dict) -> None:
