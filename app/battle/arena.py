...
class Arena:
    ...
    def __init__(self, arena_config: ArenaConfig) -> None:
        self.knights = list(
            Knight(knight_config) for knight_config in arena_config.knight_configs
        )

        self.knight_pairs = list(self.make_knight_pairs(arena_config.matchups))
    ...
    def make_knight_pairs(
        self, name_pairs: list[tuple[str, str]]
