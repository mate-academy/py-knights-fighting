...
class Knight:
    def __init__(self: Knight, knight: dict) -> None:
        self.knight = knight
    ...
    def apply_potion(knight_potion: dict) -> dict:
        if knight_potion['potion'] is not None:
            ...
            if 'hp' in knight_potion['potion']['effect']:
                knight_potion['hp'] += knight_potion['potion']['effect']['hp']

        return knight_potion

    def get_ready(self: Knight) -> None:
    ...
    def battle_start(self: Knight, knight: Knight) -> None:
        self.knight['hp'] -= \
