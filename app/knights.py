...
class Knights:
    ...
    def battle_khights(self, other):
        hp_battre = {}
        hp_battre[self.name] = self.get_hp() - other.get_power() + self.get_protection()
        hp_battre[other.name] = other.get_hp() - self.get_power() + other.get_protection()
