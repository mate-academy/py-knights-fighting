from app.Heroes.knights import Ricar
from app.config.battle_logic import Battle
...
class Preparation:
    ...
    def start_of_tournament(self) -> dict:
        ...
        lancelot = Ricar(self.config["lancelot"])
        ...
        mordred = Ricar(self.config["mordred"])
        ...
        arthur = Ricar(self.config["arthur"])
        ...
        red_knight = Ricar(self.config["red_knight"])
