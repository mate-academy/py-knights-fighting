from app.knight_training.train_all_knight import train
from app.battle.battle_of_knights import battle_knight, results
...
def battle(knightsConfig):
    ...
    train(lancelot, arthur, mordred, red_knight)
