...
staff = [red_knight, mordred, arthur, lancelot]


def battle(my_var: list[KnightsTemplate]):
    elem: KnightsTemplate
    for elem in my_var:
        # print(f"{elem.hp} {elem.name}.hp")
        # print(f"{elem.protection} {elem.name}.protection")
        # print(f"{elem.power} {elem.name}.power")
        elem.add_protection()
        elem.add_power()
        elem.apply_potion()
        # print("******" * 5)
