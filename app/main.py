...
khights_types = [lancelot, mordred, arthur, red_knight]


def battle(list_of_khights: list[KnightsTemplate]) -> dict:
    knight: KnightsTemplate
    for knight in list_of_khights:
        knight.add_power()
