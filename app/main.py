...
from app.turnament.battle import Battle
    ...
    def battle(knightsConfig):
        ...
        if arthur["potion"] is not None:
            ...
            if "protection" in arthur["potion"]["effect"]:
                arthur["protection"] += arthur["potion"]["effect"]
                ["protection"]
        ...
        if mordred["potion"] is not None:
            ...
            if "protection" in mordred["potion"]["effect"]:
                mordred["protection"] += mordred["potion"]["effect"]
                ["protection"]
        ...
        if red_knight["potion"] is not None:
            ...
            if "protection" in red_knight["potion"]["effect"]:
                red_knight["protection"] += red_knight["potion"]["effect"]
                ["protection"]
...
knights_list = [Knight.recruit_a_knight(knight) for knight in KNIGHTS.values()]

equiped_knights = [
    EquipedKnight.equip_knight(knight) for knight in knights_list
]

print(f"\n   Battle: \n{knights_list[0]}\n        VS\n{knights_list[1]}\n")
print(Battle.knights_fight(equiped_knights[0], equiped_knights[1]))

print(f"\n   Battle: \n{knights_list[2]}\n        VS\n{knights_list[3]}\n")
print(Battle.knights_fight(equiped_knights[2], equiped_knights[3]))
