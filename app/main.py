from app.parameters.armour import Armour
from app.parameters.potion import Potion
from app.parameters.weapon import Weapon
from app.knight import Knight
from app.data.knights_data import KNIGHTS


def config_knight(name: str, knights_in: dict):
