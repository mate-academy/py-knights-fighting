from knight.knights import Knight
from knight.battle import Battle
...
def battle(knights_config: dict) -> None:
    ...
    if lancelot["potion"] is not None:
        ...
        if "protection" in lancelot["potion"]["effect"]:
            lancelot[
                "protection"] += lancelot["potion"]["effect"]["protection"]
    ...
    if red_knight["potion"] is not None:
        ...
        if "protection" in red_knight["potion"]["effect"]:
            red_knight[
                "protection"] += red_knight["potion"]["effect"]["protection"]
...
# Execute battles
results_battle_1 = Battle(lancelot, mordred).execute()
results_battle_2 = Battle(arthur, red_knight).execute()

# Print results
print("Battle Results")
print("----------------")
print("Lancelot vs Mordred:", results_battle_1)
print("Arthur vs Red Knight:", results_battle_2)
