...
def battle(knights_config: dict) -> dict:
    ...
    lancelot = Knight("lancelot", knights_config)
    arthur = Knight("arthur", knights_config)
    mordred = Knight("mordred", knights_config)
    red_knight = Knight("red_knight", knights_config)
