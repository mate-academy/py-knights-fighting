...
from app.battle.battle_engine import tournament
from app.battle.preparation import prepare_knight
...
def battle(knights_config: dict) -> dict:
    ...
    res1 = tournament(lancelot, mordred)
    res2 = tournament(arthur, red_knight)
